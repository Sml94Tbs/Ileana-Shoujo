...
## Écran des dialogues #########################################################
##
## L’écran des dialogues est utilisé pour afficher les dialogues du joueur. Il prend deux paramètres, who(qui) et what(quoi) qui sont respectivement le nom du personnage en train de parler et le texte à afficher. (Le paramètre who(qui) peut être None si aucun nom n’est donné.)
##
## Cet écran affiche le texte correspondant à what. Il peut également créer un texte avec le paramètre who et l’identifiant « window » est utilisé pour déterminer les styles à appliquer.
##
...
screen say(who, what):
    ...
    ## Si il y a une side image, l'afficher au-dessus du texte. Ne pas l'afficher sur la version téléphone - pas assez de place.
...
## Écran de saisie #############################################################
##
## Cet écran est utilisé pour afficher renpy.input. Le paramètre prompt est utilisé pour passer le texte par défaut.
##
## Cet écran doit créer une entrée affichable avec l'id "input" pour accepter les différents paramètres.
##
...
## Écran des choix #############################################################
##
## Cet écran est utilisé pour afficher les choix qui seront fait par le joueur dans le jeu. Le premier paramètre, items, est une liste d'objets contenant chacun des champs de texte et d'action.
##
...
##
## Ces écrans permettent au joueur d’enregistrer le jeu et de le charger à nouveau. Comme ils partagent beaucoup d’éléments communs, ils sont tous les deux implémentés dans un troisième écran, appelé fichiers_slots (emplacement_de_fichier).
##
## https://www.renpy.org/doc/html/screen_special.html#save https://www.renpy.org/doc/html/screen_special.html#load
...
screen file_slots(title):
    ...
    use game_menu(title):
        ...
        fixed:
            ...
            ## Cette instruction s’assure que l’évènement enter aura lieu avant que l’un des boutons ne fonctionne.
            order_reverse True

            ## Le nom de la page, qui peut être modifié en cliquant sur un bouton.
            button:
                style "page_label"
...
##
## L’écran de préférences permet au joueur de configurer le jeu pour mieux correspondre à ses attentes.
##
...
##
## Cet écran est appelé quand Ren'Py souhaite poser une question au joueur dont la réponse est oui ou non.
##
## https://www.renpy.org/doc/html/screen_special.html#confirm

screen confirm(message, yes_action, no_action):

    ## Cette instruction s’assure que les autres écrans resteront en arrière plan tant que cet écran sera affiché.
    modal True
    ...
    ## Le clic bouton droit et la touche Echap. correspondent à la réponse "non".
...
##
## L’écran skip_indicator est affiché pour indiquer qu’une avance rapide est en cours.
##
...
## Cette transformation est utilisé pour faire clignoter les flèches l’une après l’autre.
...
style skip_triangle:
    ## Nous devons utiliser une police qui a le glyphe BLACK RIGHT-POINTING SMALL TRIANGLE.
    font "DejaVuSans.ttf"


## Écran de notification #######################################################
##
## Cet écran est utilisé pour affiché un message au joueur. (Par exemple, quand une sauvegarde rapide a eu lieu ou quand une capture d’écran vient d’être réalisée.)
##
...
screen nvl(dialogue, items=None):
    ...
    window:
        ...
        ## Si fourni, affiche le menu. Le menu peut s’afficher de manière incorrecte si config.narrator_menu est initialisé à True.
        for i in items:
...
## Ce paramètre contrôle le maximum d’entrée dans le mode NVL qui peuvent être affichée simultanément.
...
## Screen des bulles ###########################################################
##
## Le screen des bulles est utilisé pour afficher des dialogues en utilisant des bulles de dialogue. Ce screen prend les mêmes paramètres que le screen say, doit prévoir un displayable avec l'id "what", et peut créer des displayables avec les ids "namebox", "who", et "window".
##
...
## Comme la souris peut ne pas être présente, nous remplaçons le menu rapide avec une version qui utilise des boutons plus gros et qui sont plus faciles à toucher du doigt.
screen quick_menu():
    variant "touch"
